...
public class FilterCriteriaTest {
  ...
  public void testGetConvertedSingleValue() {
    //    FilterCriteria criteria = new FilterCriteria("publicationStart", "gt:2020-04-10",
    // LocalDate.class);
  ...
  public void testBetween() {
    //    FilterCriteria criteria = new FilterCriteria("publicationDate",
    // "btn:2020-03-01,2020-03-31", LocalDate.class);
