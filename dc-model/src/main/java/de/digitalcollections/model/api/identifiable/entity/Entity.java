 ...
 * see Wikipedia “Functional Requirements for Bibliographic Records”, URLs:
 * 
...
public interface Entity extends Identifiable {
  ...
  /**
   * @return the type of the entity (one of the types this system can manage, defined in enum EntityType).
   */
