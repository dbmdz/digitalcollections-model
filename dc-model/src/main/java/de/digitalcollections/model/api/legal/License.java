...
public interface License {
  ...
  /**
   * @return the (language independent/english) acronym for this license, e.g. "CC0 1.0" for "Public Domain" or "CC BY-NC-SA 3.0"
   */
  String getAcronym();
  ...
  /**
   * @return the url to the official public accessible documentation/specification of the license, e.g. "http://rightsstatements.org/vocab/InC-NC/1.0/"
   */
  URL getUrl();
